...
#You can add a column to a matrix with the cbind() command.Use rbind() for adding rows
...
# Create a, b, c, d variables. Number od values should be equal in the dataframe, i.e. 4 in each.It is to create
# excel like table for linear data
a <- c(10,20,30,40)
