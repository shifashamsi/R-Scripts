...
# %>% is called 'pipe operator'to give o/p of prev command to next command as input
...
## Imp If data has some values missing, replace 'NA' 
#with the mean for that column to avoid losing other values in that record
